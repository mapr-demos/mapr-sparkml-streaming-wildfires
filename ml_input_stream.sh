...
/opt/mapr/kafka/kafka-0.9.0/bin/kafka-console-consumer.sh --topic /user/mapr/ml_input:requester001 --new-consumer --zookeeper 10.1.1.14:5181 --bootstrap-server this.will.be.ignored:9092 &
while true; do
